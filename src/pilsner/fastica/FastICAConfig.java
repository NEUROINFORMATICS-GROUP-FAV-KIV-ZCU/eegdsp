...
public class FastICAConfig {
	 ...
	 */
	public FastICAConfig(int numICs, Approach approach, double stepSize,
						double epsilon, int maxIterations, double[][] initialMixingMatrix) {
		this.numICs = numICs;
	...
	/**
	 * Creates a FastICA standard configuration:<br> - deflation approach<br> -
	 * step size is one<br> - epsilon is 1.0e-12<br> - a maximum of 1000
	 * iterations<br> - no initial mixing matrix<br>
	 * 
	 * @param numICs
	...
	/**
	 * Creates a FastICA standard configuration:<br> - one independent
	 * component<br> - deflation approach<br> - step size is one<br> -
	 * epsilon is 1.0e-12<br> - a maximum of 1000 iterations<br> - no initial
	 * mixing matrix<br>
	 */
