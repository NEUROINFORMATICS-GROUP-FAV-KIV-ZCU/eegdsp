 ...
 * Symmlet4 wavelet� (d�lka 8) a mate�sk�ch koeficient�.
 * Po transformaci vznikne pole stejn� d�lky p�vodn�ho sign�lu,
 * proto�e se podvozorkov�v�.
 * 
 * @author Petr Soukal
 */
public class FastSymmlet4 {
//	mate�sk� koeficienty
    private static final double[] scale = {0.0322231006040427,
        -0.0126039672620378,
        -0.0992195435768472,
        0.297857795605277,
        0.803738751805916,
     ...
     * Metoda prodlu�uje vstupn� sign�l na d�lku (2^n) pokud v takovou d�lku nem�
     * a nov� m�sto se vypln� nulami.
     * Pokud m� sign�l d�lku 8 nebo v�t�� spou�t� inverzn� transformaci.
     *
